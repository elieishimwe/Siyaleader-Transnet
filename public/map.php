...
*/
        ...
        if ($Category == "Maintenance (Civil)")  {

             $imageCategory          = "mc";
             echo "var infoBoxBorder = '#ffff00';";
        }

        if ($Category == "Maintenance (Electrical)")  {

            $imageCategory          = "me";
            echo "var infoBoxBorder = '#ff33a6';";
        }

        if ($Category == "Maintenance (Mechanical)")  {

            $imageCategory          = "ma";
            echo "var infoBoxBorder = '#fe940b';";
        }

        if ($Category == "Maintenance (Marine)")  {
            $imageCategory          = "mm";
            echo "var infoBoxBorder = '#333dc7';";
        }

        if ($Category == "House Keeping")  {

            $imageCategory          = "hk";
            echo "var infoBoxBorder = '#00ee00';";

        }

        if ($Category == "Traffic Management")  {

            $imageCategory = "tr";
            echo "var infoBoxBorder = '#0a0c28';";
        }

        if ($Category == "Environment")  {

            $imageCategory          = "en";
            echo "var infoBoxBorder = '#009000';";
        }

        if ($Category == "Health")  {
            $imageCategory = "he";
            echo "var infoBoxBorder = '#0df1ff';";
        }

        if ($Category == "Port Operations Centre")  {

            $imageCategory          = "po";
            echo "var infoBoxBorder = '#e1e1e1';";
        }

        if ($Category == "Property")  {

             $imageCategory          = "pr";
             echo "var infoBoxBorder = '#999999';";
        }

        if ($Category == "Safety-Risk-Fire")  {

            $imageCategory          = "sr";
            echo "var infoBoxBorder = '#ff0000';";
